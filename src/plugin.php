...
Version: 1.2
Text Domain: custom-error-pages
...
if( !class_exists( 'Create_Custom_Error_Pages' ) && !class_exists( 'Custom_Error_Pages_Plugin' ) )
{
	class Custom_Error_Pages_Plugin
	{
		...
		function __construct()
		{
			...
			$this->defaults = array();
			$this->defaults['title_401'] = __( 'HTTP 401 Unauthorized', $this->slug );
			$this->defaults['content_401'] = __( 'Access denied due to invalid HTTP credentials', $this->slug );
			$this->defaults['title_403'] = __( 'HTTP 403 Forbidden', $this->slug );
			$this->defaults['content_403'] = __( 'You don\'t have permission to access this resource', $this->slug );
			...
			add_filter( "comments_template", array( $this, 'plugin_disable_comments' ) ); //Disable comments for the generated "Virtual Page"
		}
		...
		//Disable comments for the generated page.
		//This is necessary since get_comments() with $post_id = 0 will return ALL comments of the current WordPress database.
